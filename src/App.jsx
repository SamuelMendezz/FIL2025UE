            ...
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden flex flex-col max-h-[90vh]">
                ...
                <div className="p-6 overflow-y-auto space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            <label className="block text-xs font-bold text-slate-500 uppercase mb-1">Camión *</label>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            <label className="block text-xs font-bold text-slate-500 uppercase mb-1">Código UDG</label>
                    ...
                    <div className="border-t border-slate-100 pt-2">
                        ...
                        <div className="space-y-3">
                             ...
                             <input type="text" value={newPersonData.parentPhone} onChange={(e) => setNewPersonData({...newPersonData, parentPhone: e.target.value})} className="w-full px-3 py-2 border border-slate-300 rounded-lg text-sm focus:ring-2 focus:ring-indigo-500 outline-none" placeholder="Teléfono Emergencia" />
                        </div>
                    </div>
                </div>
